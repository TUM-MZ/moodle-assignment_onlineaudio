define(['jquery'], function($) {
    ...
    var module = {
        init: function(upload_url) {
            var WORKER_PATH = './submission/onlineaudio/amd/src/vendor/recorderWorker.js';
            var encoderWorker = new Worker('./submission/onlineaudio/amd/src/vendor/mp3Worker.js');
